...
import ApplyComponents from './components/ApplyComponents/index.vue'
import PersonalsettingCard from './components/PersonalsettingCard/index.vue'
...
const loginUserAvatar = computed(() => {
    return stores.userInfos.avatar
})
// 是否显示二维码
...
<template>
    ...
    <div class="img_box">
      <img :src="
        skipRouterName === 'conversation'
          ? '/@/assets/tabbar/highlightconversation.png'
          : '/@/assets/tabbar/grayconversation.png'
      " alt="">
  ...
  <div class="chat_contacts chat_icon_box" @click="changeSkipRouterName('contacts')">
    <img class="chat_contacts_icon" :src="skipRouterName === 'contacts' ? '/@/assets/tabbar/higtlightcontacts.png' : '/@/assets/tabbar/graycontacts.png'" alt="" />
  </div>
  <!-- 新建添加部分 -->
  <div class="chat_settings">
    <el-popover popper-class="setting_popover" ref="settingPopover" 
  ...
  <div class="chat_phone" @click="qrcodeShow = true">
        <el-icon>
          <Iphone />
        </el-icon>
  </div>
  ...
  >
    <div class="flex-warp">
      ...
      <div class="chat_qr flex-warp-item">
