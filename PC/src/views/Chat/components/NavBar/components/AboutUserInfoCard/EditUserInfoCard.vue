...
/* 头像相关 */
import defaultAvatar from  '/@/assets/avatarBase.png'
const avatarBaseUrl = '/@/assets/avatarBase.png'
/* 性别相关 */
const bodyIcon = '/@/assets/gender/Group76.png'
const girlIcon = '/@/assets/gender/Group77.png'
const genderIcon = {
    '1': bodyIcon,
    '2': girlIcon
}
console.log(stores.userInfos)
...
const chooseAvatar = (avatarNum) => {
    const fullAvatarUrl = `${avatarBaseUrl}`
...
const saveEditedUserInfos = async () => {
    ...
    try {
        await stores.updateMyUserInfo(params)
        ElMessage({
            type: 'success',
            message: '修改成功~'
        })
